...
(async () => {
  try {
    ...
    set('outcome-approved-n',   `${out.approved} approved · ${out.cleared||0} cleared after 221g/AP`)
    set('outcome-notapp-pct',   notAppPct + '%')
    set('outcome-notapp-n',     `${out.not_approved} pending 221g/AP`)
    set('outcome-cleared-pct',  clearedPct + '%')
    set('outcome-cleared-n',    `${out.cleared||0} cases`)
    set('outcome-pause-pct',    pausePct + '%')
    set('outcome-pause-n',      `${out.visa_pause||0} cases`)
    set('outcome-denied-pct',   deniedPct + '%')
    set('outcome-denied-n',     `${out.denied||0} cases`)
